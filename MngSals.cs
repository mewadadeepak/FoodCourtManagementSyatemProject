...
using System.Threading.Tasks;
    ...
    {
        public class MngSals : CommonFLD
        {
            ...
            AgainAndAgain:
                ...
                switch (choise)
                {
                    ...
                    addmore:
                        ...
                        arrayList.Add(date);
                        AddnewItem(@"C:\Training\DotNetTraining\FoodCourt__Management___System\sales.txt", arrayList);
                        arrayList.Clear();
                    ...
                    case 2:
                        ...
                        ViewDetailsOfItems(showcatid, showcatname, @"C:\Training\DotNetTraining\FoodCourt__Management___System\sales.txt");
                        goto AgainAndAgain;
                    case 3:
                    ...
                    updatemore:
                        ...
                        ViewDetailsOfItems(updatesalesid, updatesalesname, @"C:\Training\DotNetTraining\FoodCourt__Management___System\sales.txt");
                        ...
                        arrayList.Add(date2);
                        UpdateExistItem(updatesalesid, updatesalesname, arrayList, @"C:\Training\DotNetTraining\FoodCourt__Management___System\sales.txt");
                        arrayList.Clear();
                        Console.Write(" Do you Want more Press 1:");
